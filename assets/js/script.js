...
function toggleBiometricRecord() {
    const calculator = document.getElementById('biorecord');
...
exitBtn.addEventListener('click', () => {
    ...
    calculator.style.display = 'none'; // Hide the calculator when the EXIT button is clicked
});
